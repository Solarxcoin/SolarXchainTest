...
const MAX_NUMBER_OF_COINS_ALLOWED_TO_BE_PURCHASED = 1000;
const MAX_NUMBER_OF_COINS_ALLOWED_TO_BE_TRANSFERRED = 1000;
const NUMBER_OF_DECIMAL_PLACES = 4;
const RANDOM_TRANSACTION_FEE_COINS = [0, 0.03, 0.08, 0.10];
